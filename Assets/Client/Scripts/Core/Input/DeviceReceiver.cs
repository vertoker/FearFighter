...
namespace Core.Input
{
    public class DeviceReceiver : MonoBehaviour, IInput
    {
        ...
        private void Init()
        {
            ...
            _controls.Player.Weapon1.performed += _ => Press(KeySwitchWeapon.Katana);
            _controls.Player.Weapon2.performed += _ => Press(KeySwitchWeapon.LongStick);
            _controls.Player.Weapon3.performed += _ => Press(KeySwitchWeapon.Kusarigama);
            _controls.Player.Weapon4.performed += _ => Press(KeySwitchWeapon.Shield);
        }
